...
09/2013 - present &{\changefont{pnc}{m}{sc}Ph.D. in Experimental Particle physics} \\
 ...
 & \qquad Université Paris Sud, participation in the second year master's programme \\
...
\\
\begin{tabular}{p{3.3cm} l}
15/09/2016 & {\changefont{pnc}{m}{sc}LHCb Early-Career Scientist Award}\\
& \qquad Awarded for the development of the automated alignment of the RICH mirror \\
& \qquad system within the online data taking framework of LHCb. This was a \\
%This reduced  \\
...
%& \qquad year. 
& \qquad significant contribution to the novel real-time alignment procedures at LHCb \\
& \qquad for Run II and to the understanding of the LHCb RICH detectors. \\
...
\\
\begin{tabular}{p{3.3cm} l}
 09/2013 - present & {\changefont{pnc}{m}{sc}Measurement of the $C\!P$ even fraction of $D^0\rightarrow\pi^+\pi^-\pi^+\pi^-$ decays}\\
 & {\changefont{pnc}{m}{sc}at CLEO-c and a determination of observables related to CP}\\
 & {\changefont{pnc}{m}{sc} violation in $B^{\pm} \rightarrow DK^{\pm}$ decays at LHCb}\\
 & \qquad \textit{Ph.D. thesis} \\
 & \qquad with Dr. J. Rademacker at the University of Bristol  \\
  
 06/2012 - 06/2013 & {\changefont{pnc}{m}{sc}Analysis of the $B_d \rightarrow K^{*0} e^+ e^-$ decay at LHCb}\\
 & \qquad \textit{Master's thesis}\\
 & \qquad with Dr. M.H. Schune at the Laboratoire de l'Accelérateur Linéaire, Paris \\

 05/2011 - 07/2011 & {\changefont{pnc}{m}{sc}Study on the measurement of the CKM angle $\gamma$ at LHCb using}\\
 & {\changefont{pnc}{m}{sc}untagged $B_s \rightarrow D^0 \phi$ events}\\
 & \qquad \textit{Internship - beyond the standard curriculum} \\
 & \qquad with Dr. M.H. Schune at the Laboratoire de l'Accelérateur Linéaire, Paris \\
...
\begin{tabular}{p{3.3cm} l} 
 ...
 07/2011 - 09/2011 & {\changefont{pnc}{m}{sc}Parametrisation of rigid body dynamics in quaternions}\\
 & \qquad \textit{Bachelor's thesis} \\ 
 & \qquad with Prof. R. Schmitz at the Institute for theoretical solid state\\
 & \qquad physics (Theory C), RWTH Aachen\\
 
 
 04/2008 - 08/2008 & {\changefont{pnc}{m}{sc}Hardware close programming and calibration of a Charge to }\\
 & {\changefont{pnc}{m}{sc}Digital Converter (QDC)}\\
 & \qquad \textit{Undergraduate project - beyond the standard curriculum}\\
...
%This work was recognized by the collaboration\\
%& \qquad with the \textit{LHCb Early-Career Scientist Award}.\\
09/2013 - 04/2015 & {\changefont{pnc}{m}{sc}MINT software developer}\\
& \qquad Developer for the only software capable of modelling a generic n-body \\
& \qquad decay phase space, which is a critical component of the LHCb physics  \\
& \qquad simulation software.\\
...
forthcoming & {\changefont{pnc}{m}{sc}Amplitude analysis of $D^0 \to \pi^+\pi^-\pi^+\pi^-$ and $D^0 \to K^+K^-\pi^+\pi^-$}\\
publication & {\changefont{pnc}{m}{sc}decays using CLEO-c data}\\
...
04/04/2013 & {\changefont{pnc}{m}{sc}Photon polarisation in $b\rightarrow s\gamma$ using $B_d \rightarrow K^{*}e^+e^-$ at LHCb} \\
& \qquad Poster at the LHC France 2013 conference\\

05/03/2013 & {\changefont{pnc}{m}{sc}Analysis of the rare decay $B_d \rightarrow K^{*}e^+e^-$ at LHCb} \\
& \qquad Talk at the 77. Jahrestagung der DPG und DPG-Frühjahrstagung\\
\end{tabular}
\\
\newline
...
\\
\begin{tabular}{p{3.3cm} l}
 09/2013 - present & {\changefont{pnc}{m}{sc}XXX}\\
 & {\changefont{pnc}{m}{sc}Proper title}\\
 & \qquad \textit{Ph.D. thesis} \\
 & \qquad with Dr. J. Rademacker at the University of Bristol  \\
 & \qquad Measurement of the fractional $C\!P$-even content $F_+^{4\pi}$ of the self-conjugate\\
 & \qquad decay $D^0 \rightarrow \pi^+\pi^-\pi^+\pi^-$ using Quantum-correlated $\psi(3770)\rightarrow DD$ decays\\
 & \qquad collected by the CLEO-c experiment. The  $D \rightarrow K_S \pi^+\pi^-$ and $D \rightarrow K_L \pi^+\pi^-$\\
 & \qquad decays were used to tag the signal mode and their binned strong-phase \\
 & \qquad difference used to determine $F_+^{4\pi}$.\\
...
& \qquad  bins in the $ D\rightarrow \pi^+\pi^-\pi^+\pi^-$ phase-space simultaneously. \\
 ...
 & \qquad of the III. Physics Institute B.\\
\end{tabular}
